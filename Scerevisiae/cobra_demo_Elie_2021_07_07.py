# This python file is a demo on how to load a model and use basic cobra toolbox
# functions. I hope you find it helpful!
# First by Maya Rayle, then abstracted by Elie Eshoa, Dr Ali Zomorrodi Lab 
# Research Interns 2020 and 2021, resp. mayarayle@college.harvard.edu
# elieeshoa@gmail.com
...
try:
    ...
    warnings.warn("No `excess_nutrients` bounds were set.")
    pass        
...
try:
    ...
    warnings.warn("No `ngam_atp` bounds were set.")
    pass
...
try:
    ...
    warnings.warn("No `others` bounds were set.")
    pass
...
try:
    ...
    warnings.warn("No `regulation` bounds were set.")
    pass
...
# Setting hard coded values for some metabolite-specific bounds
...
# if fba_solution_biomass.status == "optimal":
#     # 
# else:
#     print(fba_solution_biomass.status)
...
# Showing all metabolites that got secreted out.
...
print("B: ", met_model.reactions.get_by_id('EX_h_b'))
print("E: ", met_model.reactions.get_by_id('EX_h_e_'))
