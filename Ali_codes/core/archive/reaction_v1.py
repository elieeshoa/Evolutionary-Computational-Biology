...
class reaction(object):
    ...
    Methods:
              get_eqn_by: Get the reaction equation
    print_metabolites_by: Prints in the output the list of all metabolites 
                          participating in this reaction as a reactant or product
      print_reactants_by: Prints in the output the list of all metabolites 
                          participating in this reaction as a reactan 
       print_products_by: Prints in the output the list of all metabolites 
    ...
    """
    def __init__(self, id, stoichiometry, type, name = None, Kegg_id = None, ModelSeed_id = None, model = None, subsystem = None, compartment = None, genes = [], gene_reaction_rule = None, objective_coefficient = None, flux = None, flux_bounds = [], deltaG_range = [], kinetics = None, kinetic_metabolites = None): 
        ...
        # The model in which this reaction participates
        self.model = model

        # A string containing the name of the reaction syb-system
        self.subsystem = subsystem

        # Compartment (an instance of the object compartment)
    ...
    def get_metabolites_by(self,ref_type):
        """
    ...
    def get_reactants_by(self,ref_type):
        """
    ...
    def kinetic_rate_calc(self,assignLB = False, assignUB= False, assignFlux = False, concentration_key = None):
        ...
        ------
          ...
          assignLB: Assigns the computed kinetic rate to the lower bound
                    on reaction flux (e.g., for exchange reactions), if True, and does 
        ...
        for m in self.kinetic_metabolites:
            if m.concentration == None:
                userError("**ERROR! 'concentration' for metaboltie " + m.id + ' is not defined')
            else:
                if type(concentration_key) == None: 
                ...
                elif type(concentration_key) != None:
        ...
        C = dict(C)
        exec 'self.kientic_rate = ' +  self.kinetics        
        if assignLB == True:
