...
class compound(object):
    ...
    def __init__(self, id, compartment = None, name = '', aliases = '', Kegg_id = '', ModelSeed_id = '', formula = '', molecular_weight = None, charge = None, reactions = [], reactant_reactions = [], product_reactions = [], concentration = None, deltaGf_range = [], biomass_yield = None, ms = None, notes = ''): 
